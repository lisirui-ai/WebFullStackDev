...
//
// 两种方案选其一：
//   方案A（17.1）：不使用 proxyTable，在 main.js 设置 baseURL = 'http://localhost:8000'
//                  由后端通过 django-cors-headers 配置 CORS 响应头来解决跨域
//   方案B（17.5）：使用 proxyTable 代理，不设置 baseURL（或设为空字符串 ''）
